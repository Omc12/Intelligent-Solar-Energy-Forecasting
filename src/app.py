...
from ai_pipeline.analyzer import summarize_forecast, analyze_risk
from ai_pipeline.orchestrator import run_ai_optimization
...
if plant_choice == "Plant 1":
    model_path = os.path.join(BASE_DIR, "models", "model_plant1.pkl")
else:
    model_path = os.path.join(BASE_DIR, "models", "model_plant2.pkl")
